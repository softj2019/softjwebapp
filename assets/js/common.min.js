...
if(!isMobile){
    $(document).on('mouseenter', '.links2 li a, .h-logo, .menu-btn, .slick-arrow, .more-box', function(){
    ...
    $(document).on('mouseleave', '.links2 li a, .h-logo, .menu-btn, .slick-arrow, .main-navi a, .navi-close, .more-box', function(){
...
// $(document).ready(function(){
//     let imgan = $(".phoneimg img");
//     let moImg = $(".mo-img img");
//     $(imgan, this).each(function(){
//         let imgwt = this.naturalWidth;
//         if(imgwt >= 500)
//             $(this).parent().parent('.phoneBox').css('display','none');
//     });
//     $(moImg, this).each(function(){
//         let imgwt = this.naturalWidth;
//         if(imgwt <= 200)
//             $(this).parent('.mo-img').css('display','none');
//         $(this).parent().parent('.img-box').children('.pc-img').css('width','100%');
//     });
// });